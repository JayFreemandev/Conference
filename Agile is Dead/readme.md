...
adjective로써 an agile programmer, an agile gymnast and an agile methodology 느낌으로 사용하는게 올바르다. 왜 갑자기 영어 문법 이야기를 하는지 궁금했지만 아까 말한 악의 근원을 설명하기 위해서다. 
...
선언문 이후에 많은 단어들이 생겨났다 “칸반”, “스크럼”, “스파이크” 사람들은 생전 듣도 보지도 못한 단어에 겁을 먹기 시작했다. 저건 뭔지 설명해줄 전문가가 필요해! 그러고나서 계층적인 프로젝트 구조가 사라지고 대신에 스크럼 마스터가 등장하고 QA들이 사라지고 진행 상황을 미트볼? 을 사용하거나 Velocity(속도)를 측정하기 시작한다.

왜 그럴까? 우리는 개발자로써 반짝이고 새로운 기술에 대해 관심이 있는 사람들이다. 성공적으로 자리잡은 자바스크립트 라이브러리쓰다가 뭐 하다 새로 나온게 있으면 관심이 생기고 오 신기하다 오 써보고 싶다.

insidious라고도 이야기했는데 내가 느낀점은 지적 허영심이였다. 남들이 잘 모르는걸 사용하고 알고있다는 그 우월하다고 느끼는 착각때문이다. 자신의 루비 커뮤니티는 테스팅 문화에 대해 엄청난 발전을 했고 자랑스럽게 생각하지만 한가지 거슬리는게 있다면 테스팅의 집착이다.
...
점차 소규모 팀이 아니라 큰 회사에 돈이 많은걸 알기때문에 큰 규모에 맞게 스크럼을 스케일링 업하며 세일링이 시작됬다. Dave는 이제 다시 Agility(민첩성)을 되찾을때가 왔다고 한다.  한가지만 기억하면된다 모든 디자인 패턴은 결국 하나로 부터 시작되는걸 알수있는데 “미래에 바꾸기 쉬운것” 이게 민첩성이다.
...
지난 1년동안 사람들에게 절대적인 규칙 하나를 만들어보도록 제안했었다. 내가 아는건 모든 규칙은 상황에 따라 다르다. 그렇기 때문에 누군가가 무엇을 어떻게 해야하는지 알려준다면 들을 필요가없다. 

왜냐하면 그 사람들도 모르기 때문이다. 만약 어떤 책에서 소프트웨어 짜는법을 알려준다면 그것도 틀렸다. 당신이 만드는 그 특정한 프로젝트를 위한것도, 당신의 팀이나 회사를 위한것도 아니기 때문이다. 

당신이 할 일은 다음 어떤 상황이 일어날지도 모르는 단계에서 small step을 한 걸음 내 딛고 계획을 적용하고 계속 반복하는것이다. 세상에 이때까지 말한게 전부 애자일 프로세스, 애자일 삶 이랑 같다. 그럼 애자일 프로젝트란 뭔가?
...
물론 용기란 개인의 용기뿐만 아니라 팀과 회사또한 그래야한다 이것이 Dave가 이야기한 초창기의 애자일, 민첩한 가치로 돌아갈수있는 유일한 방법이기때문이다.  Dave Thomas는 강연의 핵심적인 말을 언급하며 마무리 지었다.
...
이런 감시와 압박속에 쓸때없는 작업을 불려쓰거나 속이거나 정말 게을러지거나 서비스 퀄리티와 생산성은 더 낮아지고 Kanban또한 생산성 저하 문제와 신뢰성 문제를 언급했다. 애자일 주의자들은 자기 팀원들에게 그만큼의 권한을 부여하지않는다 소통이라는 단어 아래 그저 자신을 설득하게 만들기에 생각하는 애자일은 존재할수없다. 

How가 아닌 조직원들의 내적 동기와 개발 철학, 자유로운 조직 문화 아래서 퍼포먼스를 낼 수 있다고 생각한다. 현대 시대에서는 더이상 크런치 모드로 압박하고 시간과 타인으로부터 경쟁시키는 환경에서는 뛰어난 아이디어와 해결책이 나올수없다.
...
10개월의 신규프로젝트를 출시하는 과정에서 크런치 모드로 주 70~80시간을 투자하며 주말 밤낮없이 오픈 스펙에 맞추기 위해 팀원들과 일했었다. 사람의 내적 동기가 바닥을 보이고 눈동자에 열정이 없어지는 기간은 사람마다 달랐지만 평균적으로 6개월이 넘어가는 순간 모두가 지쳐있었다. 
